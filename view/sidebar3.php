...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="parent_write_comment.php"><i class="fa fa-circle-o"></i> Write Comment</a></li>
            <li><a href="parent_view_comment.php"><i class="fa fa-circle-o"></i> View Comments</a></li>
          </ul>
        </li>

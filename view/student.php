              	...
              	<div class="box box-primary">
                	<div class="box-header with-border">
                        				...
                        				<div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divPhone">
                                                ...
                                                <div class="col-xs-7" id="divPhone1">
                                                	<input type="text" class="form-control" id="phone" name="phone" placeholder="1111111111">
                                                </div> 
                                        	</div>  
                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGPhone">
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" placeholder="1111111111" >
                                                </div> 
                                        	</div>
                       ...
                       <div class="box-footer text-right">
                    		...
                    		<button style="width:150px;" type="submit" class="btn text-right btn-success asd" id="btnSubmit">submit</button><br>
